...
def training_loop(
    ...
    if rank == 0:
        ...
        misc.print_module_summary(D_parsing, [torch.cat([F.gumbel_softmax(img[2],tau=1, hard=True, dim=1), pose],dim=1), c_feature])
    ...
    while True:
        ...
        with torch.autograd.profiler.record_function('data_fetch'):
            ...
            phase_real, phase_pose, phase_norm_img, phase_norm_img_lower, phase_denorm_upper_img, phase_denorm_lower_img, _, \
                phase_gt_parsing, phase_denorm_upper_mask, phase_denorm_lower_mask, _, _, phase_retain_mask, phase_face_mask = next(training_set_iterator)
